...
public class ArangoQueryStore extends QueryStore
{
    public ArangoQueryStore( String path )  throws DbException
    {
        super(path, ".aql");
    }

    protected Converter getConverter() {
        return new org.ldbcouncil.snb.impls.workloads.arango.converter.ArangoConverter();
    }
